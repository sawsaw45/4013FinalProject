        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="">
                    ...
                    <div class="mb-3">
                        <label for="Priority<?php echo $note['Priority']?>" class="form-label">Priority Level <span class="bg-secondary border border-3 border-dark"><span class="text-success">1</span>-<span class="text-danger">10</span></span></label>
