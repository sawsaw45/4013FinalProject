...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editToDoModal<?php echo $note['noteid']; ?>-timer" date-data-due="<?php echo $note['Due Date']?>">
...
<div class="modal fade" id="editToDoModal<?php echo $note['noteid']; ?>-timer" tabindex="-1" aria-labelledby="editToDoModalLabel<?php echo $note['noteid']; ?>" aria-hidden="true">
            ...
            <div class="modal-body">
                <form method="post" action="">
                    ...
                    <div class="mb-3">
                        ...
                        <a id="editToDoModal<?php echo $note['noteid']; ?>-timer"></a>
                    </div>
