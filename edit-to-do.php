...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editToDoModal<?php echo $note['noteid']; ?>-timer" date-date-due="<?php echo $note['Due Date']?>">
